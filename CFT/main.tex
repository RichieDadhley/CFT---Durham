...
\newtheorem{adremark}[theorem]{Additional Remark}
...
\begin{titlepage}
	\centering
	    ...
	    {\LARGE Conformal Field Theory} % Title
	    ...
	    {\scshape\Large Dr. Paul Heslop} % Lecturer Name
...
These are my notes on the 2020 lecture course "Conformal Field Theory" taught by Dr. Paul Heslop at Durham University as part of the Particles, Strings and Cosmology Msc. For reference, the course lasted 16 hours and was taught over 4 weeks. \\
...
I would like to extend a message of thanks to Dr. Heslop for teaching this course. I would also like to thank Thimo Preis for helping getting these notes started.\\
...
These notes are not endorsed by Dr. Heslop or Durham University.
...
\input{sections/00Comments.tex}
\input{sections/01introduction.tex}
\part{CFT in $D > 2$}
\input{sections/02ConformalTransformations.tex}
\input{sections/03Fields.tex}
\input{sections/04Correlation.tex}
\input{sections/05RadialQuantisation.tex}
\input{sections/06ConformalBlocks.tex}
\part{CFT in $2D$}
\input{sections/07CFT2D.tex}
\input{sections/08FreeBoson.tex}
\input{sections/09bcGhost.tex}
